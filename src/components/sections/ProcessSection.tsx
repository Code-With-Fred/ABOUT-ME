        ...
        >
          ...
          <div className="space-y-0">
            {steps.map((step, i) => (
              ...
              >
                <div className="flex gap-4 sm:gap-6 md:gap-8 py-5 sm:py-8 border-b border-border/30 hover:border-primary/20 transition-colors">
                  <div className="flex flex-col items-center gap-2 pt-1">
                    <span className="text-[10px] sm:text-xs font-mono text-primary font-bold">{step.number}</span>
                    {i < steps.length - 1 && (
                  ...
                  <div className="flex-1 pb-1 sm:pb-2">
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                      ...
                      <h3 className="text-base sm:text-lg md:text-xl font-bold font-display group-hover:text-primary transition-colors">
                        {step.title}
                      </h3>
                    </div>
